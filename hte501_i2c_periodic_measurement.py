...
try:
    ...
    HTE_501.change_periodic_measurement_time(5000)
    print("periodic measurement time interval is: "+str(HTE_501.read_periodic_measurement_time()) +
          " s")
except Warning as exception:
    print("Exception: " + str(exception))

HTE_501.start_periodic_measurement()
# print csv header
...
for i in range(300):
    ...
    try:
        if HTE_501.new_measurement_ready():
            temperature,humidity = HTE_501.get_periodic_measurement_temp_hum()
        ...
        time.sleep(0.1)
HTE_501.end_periodic_measurement()
